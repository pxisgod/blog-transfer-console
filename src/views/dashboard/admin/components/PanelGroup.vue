...
import { statAll } from "@/api/logStat";
...
export default {
  ...
  methods: {
    ...
    initme() {
      statAll().then(response => {
        this.logNum = response.data.logNum;
        this.errNum = response.data.errNum;
        this.successNum = response.data.successNum;
        this.filterNum = response.data.filterNum;
      });
    }
  }
};
