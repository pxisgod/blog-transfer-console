<template>
  <vp-row class="app-container" :gutter="32">
    <vp-col :xs="24" :sm="24" :lg="6">
      <vp-card class="box-card">
        <div slot="header" class="clearfix">
          <span style="line-height:36px;">ES错误处理偏移量</span>
        </div>
    ...
    <vp-col :xs="24" :sm="24" :lg="18">
      <vp-card class="box-card">
        <div slot="header" class="clearfix">
          <span style="line-height:36px;">错误处理速度变化曲线</span>
...
import { getEsOffset, getEsOffsetTrend } from "@/api/kafkaMonitor";
